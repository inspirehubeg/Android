...
object Util {
    const val BASE_URL="http://192.168.1.47:8080/api/v1/"
    const val BASE_URL_TEST="https://jsonplaceholder.typicode.com"
    const val POSTS_URL="$BASE_URL_TEST/posts"
    const val CATEGORIES_URL="http://192.168.1.47:8080/api/v1/categories?since=0"
    const val BOOK_INFO_URL="http://192.168.1.47:8080/api/v1/users/1/books?limit=6&offset=0&since=0"
    const val TOKEN_URL= "http://192.168.1.47:8080/api/v1/books/1/tokens/1"

    //const val BOOK_URL= "http://192.168.1.47:8080/api/v1/books/1"

    const val BOOK_INFO_ENDPOINT="books/"
    const val TOKEN_ENDPOINT="/tokens/"
    ...
    const val METADATA_FOR_BOOK_ENDPOINT="metadata"
